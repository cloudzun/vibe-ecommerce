...
async function initDb() {
  ...
  if (!hasProducts) {
    ...
    await knex('products').insert([
      ...
      { id: 3, name: 'USB-C Hub', category: 'accessories', price: 49.99, rating: 4.3, description: '7-in-1 hub with 4K HDMI, 100W PD charging, and USB 3.0 ports.', image: 'https://images.unsplash.com/photo-1601524909162-ae8725290836?w=400&h=300&fit=crop' },
      { id: 4, name: 'Webcam HD', category: 'computers', price: 89.99, rating: 4.4, description: '1080p webcam with built-in ring light and noise-canceling microphone.', image: 'https://images.unsplash.com/photo-1535303311164-664fc9ec6532?w=400&h=300&fit=crop' },
      { id: 5, name: 'Portable SSD', category: 'storage', price: 109.99, rating: 4.6, description: '1TB portable SSD with USB 3.2 Gen 2, up to 1050MB/s read speed.', image: 'https://images.unsplash.com/photo-1639322537228-f710d846310a?w=400&h=300&fit=crop' },
      ...
      { id: 9, name: 'Monitor Stand', category: 'accessories', price: 39.99, rating: 4.1, description: 'Ergonomic monitor stand with cable management and USB hub.', image: 'https://images.unsplash.com/photo-1616763355548-1b606f439f86?w=400&h=300&fit=crop' },
